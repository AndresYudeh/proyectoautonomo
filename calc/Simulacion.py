...
class Simulacion:
    ...
    def modeloInventario(self):
        ...
        indice = ['Q','Costo de ordenar','Costo de mantenimiento','Costo total','Diferencia del costo total']
        ...
        for period in periodo:
            dfQ['Costo de ordenar'][period] = D * Co / dfQ['Q'][period]
            dfQ['Costo de mantenimiento'][period] = dfQ['Q'][period] * Ch / 2
            dfQ['Costo total'][period] = dfQ['Costo de ordenar'][period] + dfQ['Costo de mantenimiento'][period]
            dfQ['Diferencia del costo total'][period] = dfQ['Costo total'][period] - MOQ
        data ['df'] = dfQ
        dfG = dfQ.loc[:,'Costo de ordenar':'Costo total']
    ...
    def banco(self):
        ...
        for i in Clientes:
            if i == 0:
                ...
                dfLE['TIESA'][i] = round(dfLE['TIESP'][i] + dfLE['TISE'][i],2)
        columnas = ["LLEGADA INICIAL","SERVICIO ESTIMADO","TIEMPO DE LLEGADA","TIEMPO DE SERVICIO",
            "TIEMPO EXACTO DE LLEGADA","TIEMPO INICIO SERVICIO","TIEMPO FIN SERVICIO","TIEMPO DE ESPERA","TIEMPO DE SALIDA"]
